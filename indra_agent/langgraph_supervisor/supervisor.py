...
from indra_agent.langgraph_supervisor.agent_name import (
    AgentNameMode,
    with_agent_name,
)
from indra_agent.langgraph_supervisor.handoff import (
...
def create_supervisor(
    ...
    **deprecated_kwargs: Unpack[DeprecatedKwargs],
    ...
    Example:
        ...
        from indra_agent.langgraph_supervisor import create_supervisor
